                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url(); ?>Administrar/Categoria_Controller"><i class="fa fa-circle-o"></i> Categorias</a></li>
                            <li><a href="<?php echo base_url(); ?>Administrar/Cliente_Controller"><i class="fa fa-circle-o"></i></i> Clientes</a></li>
                            <li><a href="<?php echo base_url(); ?>Administrar/Producto_Controller"><i class="fa fa-circle-o"></i></i> Productos</a></li>
                            <li><a href="<?php echo base_url(); ?>Administrar/Roles_Controller"><i class="fa fa-circle-o"></i></i> Roles</a></li>
                            <li><a href="<?php echo base_url(); ?>Administrar/Usuario_Controller"><i class="fa fa-circle-o"></i></i> Usuarios</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
