            ...
            <section class="content">
                ...
                <div class="box box-solid">
                    ...
                    <div class="row">
                        ...
                        <form action= "<?php echo base_url(); ?>Administrar/Cliente_Controller/actualizar_cliente" method = "POST">
                        <input type ="hidden" name="idN" value="<?php echo $cliente->id_cliente;?>" >
                        <input type ="hidden" name="identificacionAnt" value="<?php echo $cliente->identificacion;?>" >
