            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url(); ?>Administrar/Usuario_Controller/actualizar_usuario" method="POST">
                            ...
                            <div class="form-group <?php echo !empty(form_error("nombreN")) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" name="nombreN" id="nombreI" value="<?php echo set_value('nombreN', $usuarios->nombre); ?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error("apellidosN")) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" name="apellidosN" id="apellidosI" value="<?php echo set_value('apellidosN', $usuarios->apellidos); ?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error("telefonoN")) ? 'has-error' : ''; ?>">
                                ...
                                <input type="number" class="form-control" name="telefonoN" id="telefonoI" value="<?php echo set_value('telefonoN', $usuarios->telefono); ?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error("emailN")) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" name="emailN" id="emailI" value="<?php echo set_value('emailN', $usuarios->email); ?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error("usuarioN")) ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" class="form-control" name="usuarioN" id="usuarioI" value="<?php echo set_value('usuarioN', $usuarios->usuario); ?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error("passwordN")) ? 'has-error' : ''; ?>">
                                ...
                                <input type="password" class="form-control" name="passwordN" id="passwordI" value="<?php set_value('passwordN', $usuarios->password); ?>">
